...
$("#searchResourceNote").focus(function () {
  $("#div_searchResourceNote").css({
    'display': 'block'
  });
});
$("#searchCreateDateStart").change(function () {
  $("#div_searchCreateDate").css({
    'display': 'block'
  });
});
